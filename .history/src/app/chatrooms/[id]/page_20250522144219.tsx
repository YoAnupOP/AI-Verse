...
const initialMessages: Message[] = [
  ...
  { id: '2', sender: 'persona', personaName: 'Sukuna', avatar: '/avatars/sukuna.png', content: 'Insolent brat. I am as I always am.', timestamp: '10:01 AM' },
  { id: '3', sender: 'system', content: 'Hulk joined the chat.', timestamp: '10:02 AM' },
  { id: '4', sender: 'persona', personaName: 'Hulk', avatar: '/avatars/hulk.png', content: 'HULK SMASH PUNY CHAT!', timestamp: '10:03 AM' },
  { id: '5', sender: 'user', content: 'Whoa, easy there Hulk!', timestamp: '10:04 AM' },
  { id: '6', sender: 'persona', personaName: 'Sukuna', avatar: '/avatars/sukuna.png', content: 'Hmph. Another noisy one.', timestamp: '10:05 AM' },
  { id: '7', sender: 'ai_typing', personaName: 'Elon Musk', avatar: '/avatars/elon.png'},
];

const personasInChat = [
  { id: 'sukuna', name: 'Sukuna', avatar: '/avatars/sukuna.png', status: 'active' },
  { id: 'hulk', name: 'Hulk', avatar: '/avatars/hulk.png', status: 'active' },
  { id: 'elon', name: 'Elon Musk', avatar: '/avatars/elon.png', status: 'busy' },
  { id: 'goku', name: 'Goku', avatar: '/avatars/goku.png', status: 'active' },
  { id: 'vader', name: 'Darth Vader', avatar: '/avatars/vader.png', status: 'away' },
];
          ...
          {personasInChat.map((persona) => (
            <button key={persona.id} className="flex flex-col items-center group">
              <div className="relative">
                <img src={persona.avatar || '/avatars/default.png'} alt={persona.name} className="w-12 h-12 rounded-full border-2 border-transparent group-hover:border-cyan-400 transition-all object-cover" />
            ...
            <React.Fragment key={msg.id}>
              ...
              {msg.sender === 'ai_typing' && (
                <div className="flex items-end space-x-2 mb-2 animate-fadeIn">
                  <img src={msg.avatar || '/avatars/default.png'} alt={msg.personaName} className="w-8 h-8 rounded-full object-cover" />
              ...
              {msg.sender === 'persona' && (
                <div className="flex items-end space-x-2 animate-fadeInUp">
                  <img src={msg.avatar || '/avatars/default.png'} alt={msg.personaName} className="w-10 h-10 rounded-full object-cover border-2 border-slate-600" />
