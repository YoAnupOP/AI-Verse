  ...
  return (
    <Link href={`/chatrooms/${id}`} className="flex-shrink-0 w-[230px] md:w-full">
      ...
      >
        ...
        {/* Thumbnail Section */}
        {/* Thumbnail Section */}
<div className="relative w-full h-[120px] sm:h-[130px] md:h-[140px] rounded-t-[20px] overflow-hidden">
              <img 
                src={thumbnail}
                alt={name}
                className="w-full h-full object-cover object-center" // e.g., object-top, object-bottom, object-left, object-right. Default is object-center.
              />
