...
<div className="hidden md:flex fixed left-0 top-0 h-screen z-40 flex-col items-center bg-black/40 backdrop-blur-lg shadow-lg border-r border-green-400/20 glow-sm">
