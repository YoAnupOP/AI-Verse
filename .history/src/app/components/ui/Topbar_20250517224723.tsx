   ...
   return (
    <header className="flex justify-between items-center px-4 sm:px-6 py-3 bg-transparent text-white sticky top-0 z-40">
      ...
      <div className="flex items-center">
        <Link href="/" className="flex items-center group"> {/* Simplified className for the Link */}
          <motion.div
          ...
          >
            ...
            <svg 
              ...
              className="h-9 w-9 sm:h-12 sm:w-[180px] looka-1j8o68f" // Responsive width and height
            >
