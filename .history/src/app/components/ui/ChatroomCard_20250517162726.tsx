  ...
  return (
    <Link href={`/chatrooms/${id}`} className="flex-shrink-0 w-[230px] md:w-full block" aria-label={`View details for chatroom: ${name}`}>
      ...
      >
        ...
        <div className="flex-1 p-2 sm:px-3.5 sm:pt-2.5 sm:pb-3 md:px-4 md:pt-3 md:pb-4 flex flex-col relative z-[2]"> {/* MODIFIED padding */}
          ...
          {/* Description */}
          <p className="text-gray-200 text-xs sm:text-sm mb-2 sm:mb-3 line-clamp-2 min-h-[2rem] sm:min-h-[2.5rem]">
            {description}
          </p>
