...
export default function GameCard({ id, title, logoUrl, matches, gamePath }: GameCardProps) {
  return (
    <div 
      className="bg-[rgba(10,12,18,0.8)] rounded-[20px] border border-[rgba(0,255,170,0.4)] shadow-xl p-5 flex flex-col sm:flex-row items-stretch w-full max-w-2xl mx-auto text-white transition-all duration-300 ease-out hover:shadow-cyan-500/20 hover:border-[rgba(0,255,170,0.6)]"
