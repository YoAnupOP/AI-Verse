  ...
  return (
    <Link href={`/chatrooms/${id}`} className="flex-shrink-0 w-[230px] md:w-full block" aria-label={`View details for chatroom: ${name}`}>
      ...
      >
        ...
        <div className="flex-1 p-2 sm:px-3 sm:pt-3 sm:pb-4 md:px-4 md:pt-4 md:pb-5 flex flex-col relative z-[2]">
          ...
          {/* Description */}
          <p className="text-gray-200 text-xs sm:text-sm line-clamp-1 min-h-[2rem] sm:min-h-[2.5rem]">
            {description}
          </p>
