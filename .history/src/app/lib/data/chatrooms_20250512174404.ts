...
export const chatrooms: Chatroom[] = [
  {
    id: 1,
    name: 'Anime-Verse',
    description: 'Discuss art, writing, and music with creative personas',
  ...
  },
  {
    id: 2,
    name: 'Marvel-Verse',
    description: 'Explore the Marvel universe with fellow fans',
  ...
  },
  {
    id: 3,
    name: 'DC-Verse',
    description: 'Join discussions about DC superheroes and comics',
