...
<div className="hidden md:flex fixed left-0 top-1/2 -translate-y-1/2 z-40 flex-col items-center bg-black/40 backdrop-blur-lg rounded-r-3xl shadow-lg border-y border-r border-green-400/20 glow-sm">
